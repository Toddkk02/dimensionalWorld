...
DimensionConfig DimensionManager::CreatePurpleDimension() {
    ...
    config.waterTexture = "assets/textures/purple_water.png";
...
DimensionConfig DimensionManager::CreateGreenDimension() {
    ...
    config.grassTopTexture = "assets/textures/grass_top.png";
    config.dirtSideTexture = "assets/textures/dirt_side.png";
    config.dirtTexture = "assets/textures/dirt.png";
    config.waterTexture = "assets/textures/water.png";
    
    config.skyboxTexture = "assets/textures/skybox_green.jpg";
...
DimensionConfig DimensionManager::CreateRedDimension() {
    ...
    config.grassTopTexture = "assets/textures/red_alien.png";
    config.dirtSideTexture = "assets/textures/red_rock_side.png";
    config.dirtTexture = "assets/textures/red_rock.png";
...
DimensionConfig DimensionManager::CreateDesertDimension() {
    ...
    config.dirtSideTexture = "assets/textures/sandstone_side.png";
    config.dirtTexture = "assets/textures/sandstone.png";
    config.waterTexture = "assets/textures/oasis_water.png";
...
DimensionConfig DimensionManager::CreateIceDimension() {
    ...
    config.grassTopTexture = "assets/textures/snow.png";
    config.dirtSideTexture = "assets/textures/ice_side.png";
    config.dirtTexture = "assets/textures/ice.png";
    config.waterTexture = "assets/textures/frozen_water.png";
...
DimensionConfig DimensionManager::CreateVolcanoDimension() {
    ...
    config.grassTopTexture = "assets/textures/volcanic_rock.png";
    config.dirtSideTexture = "assets/textures/obsidian_side.png";
    config.dirtTexture = "assets/textures/obsidian.png";
    config.waterTexture = "assets/textures/lava_flow.png";
...
DimensionConfig DimensionManager::CreateSpaceDimension() {
    ...
    config.grassTopTexture = "assets/textures/asteroid.png";
    config.dirtSideTexture = "assets/textures/moon_rock_side.png";
    config.dirtTexture = "assets/textures/moon_rock.png";
